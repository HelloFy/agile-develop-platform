 ...
 */
package cn.edu.xidian.platform.gen.utils;
...
import cn.edu.xidian.platform.commons.mapper.JaxbMapper;
import cn.edu.xidian.platform.commons.utils.DateUtils;
import cn.edu.xidian.platform.commons.utils.FileUtils;
import cn.edu.xidian.platform.commons.utils.FreeMarkers;
import cn.edu.xidian.platform.commons.utils.StringUtils;
import cn.edu.xidian.platform.gen.entity.GenCategory;
...
//		}
	...
	public static Map<String, Object> getDataModel(GenScheme genScheme,GenTable genTable){
		...
		model.put("functionAuthor", StringUtils.isNotBlank(genScheme.getFunctionAuthor())?genScheme.getFunctionAuthor():Global.getAuthorName());
	...
	public static String generateToFile(GenTemplate tpl, Map<String, Object> model, boolean isReplaceFile){
        ...
        if (StringUtils.equalsIgnoreCase(tpl.getName(), "controller")
                || StringUtils.equalsIgnoreCase(tpl.getName(), "html")) {
