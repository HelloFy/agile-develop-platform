jQuery.extend({
                  ...
                  createUploadForm: function (id, fileElementId, data) {
                      ...
                      if (data) {
                          for (var i in data) {
                              jQuery('<input type="hidden" name="' + i + '" value="' + data[i]
                                     + '" />').appendTo(form);
                          }
                      }
                  ...
                  ajaxFileUpload: function (s) {
                      // TODO introduce global settings, allowing the client to modify them for all
                      // requests, not only timeout
                      s = jQuery.extend({}, jQuery.ajaxSettings, s);
                      var id = new Date().getTime()
                      var form = jQuery.createUploadForm(id, s.fileElementId,
                                                         (typeof(s.data) == 'undefined' ? false
                                                             : s.data));
                      ...
                      var uploadCallback = function (isTimeout) {
                          ...
                          try {
                              if (io.contentWindow) {
                                  xml.responseText =
                                      io.contentWindow.document.body
                          ...
                          if (xml || isTimeout == "timeout") {
                              ...
                              try {
                                  ...
                                  if (status != "error") {
                                      // process the data (runs the xml through httpData regardless
                                      // of callback)
