...
require('../../template/gen/genTableForm.html');
                                     ...
                                     onPageChange: function (num, type) {
                                         $.ajax('gen/getBusinessTables', {
                                             ...
                                             data: {
                                                 ...
                                                 tableComments: $('#tableComments').val(),
                                                 className: $('#className')
                                             },
                                             success: function (data) {
                                                 var isSuccess = data.result == 'SUCCESS' ? true
                                                     : false;
                                                 if (isSuccess) {
                                                     var message = data.message;
                                                     console.log(message);
                                                     ...
                                                     $.each(message.page,
                                                            function (index, content) {
                                                                html += "<tr>";
                                                                html +=
                                                                    "<td>" + content.tableName
                                                                    + "</td>";
                                                                html +=
                                                                    "<td>" + content.tableComments
                                                                    + "</td>";
                                                                html +=
                                                                    "<td>" + content.className
                                                                    + "</td>";
                                                                html +=
